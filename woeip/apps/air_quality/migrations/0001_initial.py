    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=256)),
                ('email', models.CharField(max_length=256)),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='air_quality.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='Route',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collected_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='air_quality.Participant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='air_quality.Participant')),
            ],
        ),
        migrations.AddField(
            model_name='organization',
            name='contact',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contact', related_query_name='contact', to='air_quality.Participant'),
        ),
        migrations.AddField(
            model_name='data',
            name='session_data',
