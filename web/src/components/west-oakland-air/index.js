...
export const WestOaklandsAir = () => (
  <Container>
    ...
    <div class="ui container about-container">
      ...
      <p><img class="ui fluid image" src={trucks} alt="Two cargo trucks cross paths on a residential street" /></p>
      <p>
      ...
      <p>
      <div className="ui button violet huge woa-button"><a href="/about" className="woa-button">Shifting power</a></div>
      <div className="ui button violet huge woa-button"><a href="/maps" className="woa-button">Explore the map</a></div>
      </p>
