...
export const About = () => (
  <Container>
    ...
    <p>West Oakland Air Quality (WOAQ) helps West Oaklanders like you understand your local air quality and fight for cleaner air.</p>
    <p>WOAQ is a project of <a href="https://openoakland.org">OpenOakland</a>, a volunteer-led brigade of the nonprofit Code for America, and the <a href="https://woeip.org">West Oakland Environmental Indicators Project</a> (WOEIP), a community-based environmental justice organization that uses participatory research to achieve healthy neighborhoods for all who live, work, learn and play in West Oakland, California.</p>
    <p>Designed to power WOEIP’s citizen science program, WOAQ helps you visualize the neighborhood air quality data collected by you and your neighbors, explore the environmental issues that directly impact your health and well-being, and reclaim the air you breathe every day.</p>

    <h3 className="ui header">Tools for the community</h3>

    <p>For decades, the West Oakland Environmental Indicators Project, a community-led nonprofit, has led a groundbreaking process of <a href="https://woeip.org/our-approach/">participatory research and collaborative problem-solving</a> to reclaim and clean up the neighborhood’s air. Equipping residents of all ages with mobile air sensors, WOEIP staff and volunteers took to the streets to record what people intuitively sensed: that all air is not equal.</p>
    <p>WOEIP partnered with INTEL to create a citizen science program that helped community members understand the science behind air pollution and how to use data to advocate for real-world, systems-level change. This work served as the foundation of research that has led to one of the most community-rooted air pollution mitigation plans in the country, <i><a href="https://woeip.org/featured-work/owning-our-air/">Owning Our Air</a></i>.</p>
    <p>But when the initial funding ran out, WOEIP’s air quality database disappeared with it.</p>
    <p>The West Oakland Air Quality project re-envisions that original platform so WOEIP can empower another generation of residents to continue this critical work.</p>
